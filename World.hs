...
-- Return a new creature and whether the creature was moved
moveCreature :: MonadState World m => Creature -> (Int, Int, Int) -> m (Creature, Bool)
...
moveItem :: MonadState World m => Item -> (Int, Int, Int) -> m (Item, Bool)
